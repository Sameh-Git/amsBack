(self["webpackChunkamsIonic"] = self["webpackChunkamsIonic"] || []).push([["main"],{
...
/* harmony import */ var _services_authguard_service__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./services/authguard.service */ 8805);
...
const routes = [
    ...
    {
        path: 'provider',
        loadChildren: () => Promise.all(/*! import() */[__webpack_require__.e("common"), __webpack_require__.e("src_app_provider_provider_module_ts")]).then(__webpack_require__.bind(__webpack_require__, /*! ./provider/provider.module */ 4533)).then(m => m.ProviderPageModule),
        canActivate: [_services_authguard_service__WEBPACK_IMPORTED_MODULE_0__.AuthguardService]
    },
    {
        path: 'add-provider',
        loadChildren: () => Promise.all(/*! import() */[__webpack_require__.e("common"), __webpack_require__.e("src_app_add-provider_add-provider_module_ts")]).then(__webpack_require__.bind(__webpack_require__, /*! ./add-provider/add-provider.module */ 2642)).then(m => m.AddProviderPageModule),
        canActivate: [_services_authguard_service__WEBPACK_IMPORTED_MODULE_0__.AuthguardService]
    },
    {
        path: 'update-provider/:id',
        loadChildren: () => Promise.all(/*! import() */[__webpack_require__.e("common"), __webpack_require__.e("src_app_update-provider_update-provider_module_ts")]).then(__webpack_require__.bind(__webpack_require__, /*! ./update-provider/update-provider.module */ 5090)).then(m => m.UpdateProviderPageModule),
        canActivate: [_services_authguard_service__WEBPACK_IMPORTED_MODULE_0__.AuthguardService]
    },
    {
        path: 'login',
    ...
    {
        path: 'article',
        loadChildren: () => Promise.all(/*! import() */[__webpack_require__.e("common"), __webpack_require__.e("src_app_article_article_module_ts")]).then(__webpack_require__.bind(__webpack_require__, /*! ./article/article.module */ 5745)).then(m => m.ArticlePageModule),
        canActivate: [_services_authguard_service__WEBPACK_IMPORTED_MODULE_0__.AuthguardService]
    },
    {
        path: 'add-article',
        loadChildren: () => Promise.all(/*! import() */[__webpack_require__.e("common"), __webpack_require__.e("src_app_add-article_add-article_module_ts")]).then(__webpack_require__.bind(__webpack_require__, /*! ./add-article/add-article.module */ 3370)).then(m => m.AddArticlePageModule),
        canActivate: [_services_authguard_service__WEBPACK_IMPORTED_MODULE_0__.AuthguardService]
    },
    {
        path: 'update-article/:id',
        loadChildren: () => Promise.all(/*! import() */[__webpack_require__.e("common"), __webpack_require__.e("src_app_update-article_update-article_module_ts")]).then(__webpack_require__.bind(__webpack_require__, /*! ./update-article/update-article.module */ 6651)).then(m => m.UpdateArticlePageModule),
        canActivate: [_services_authguard_service__WEBPACK_IMPORTED_MODULE_0__.AuthguardService]
    }
];
...
/* harmony import */ var _services_basic_auth_interceptor_service__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./services/basic-auth-interceptor.service */ 549);
...
AppModule = (0,tslib__WEBPACK_IMPORTED_MODULE_3__.__decorate)([
    (0,_angular_core__WEBPACK_IMPORTED_MODULE_4__.NgModule)({
        ...
        providers: [{ provide: _angular_router__WEBPACK_IMPORTED_MODULE_8__.RouteReuseStrategy, useClass: _ionic_angular__WEBPACK_IMPORTED_MODULE_6__.IonicRouteStrategy },
            { provide: _angular_common_http__WEBPACK_IMPORTED_MODULE_7__.HTTP_INTERCEPTORS, useClass: _services_basic_auth_interceptor_service__WEBPACK_IMPORTED_MODULE_2__.BasicAuthInterceptorService, multi: true
            }],
...
let AuthenticationService = class AuthenticationService {
    ...
    authenticate(username, password) {
        ...
        return this.httpClient.get(src_environments_environment__WEBPACK_IMPORTED_MODULE_0__.environment.urlAuth, { headers }).pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_2__.map)(userData => {
...
/***/ 549:
/*!************************************************************!*\
  !*** ./src/app/services/basic-auth-interceptor.service.ts ***!
  \************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "BasicAuthInterceptorService": () => (/* binding */ BasicAuthInterceptorService)
/* harmony export */ });
...
BasicAuthInterceptorService = (0,tslib__WEBPACK_IMPORTED_MODULE_0__.__decorate)([
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ("<ion-app >\n  <ion-split-pane contentId=\"main-content\">\n    <ion-menu contentId=\"main-content\" type=\"overlay\" >\n      <ion-content  >\n        <ion-list id=\"inbox-list\"  *ngIf=\"loginService.isUserLoggedIn()\">\n          <ion-list-header><h4 style=\"color: navy;\">Articles Management System </h4> \n        \n            \n          </ion-list-header>\n          <ion-note>{{loginService.susername}}\n          <br>\n          {{loginService.srole}}</ion-note>\n\n          <ion-menu-toggle auto-hide=\"false\" *ngFor=\"let p of appPages; let i = index\" >\n            <ion-item *ngIf=\"p.auth\" routerDirection=\"root\" [routerLink]=\"[p.url]\" lines=\"none\" detail=\"false\" routerLinkActive=\"selected\">\n              <ion-icon slot=\"start\" [ios]=\"p.icon + '-outline'\" [md]=\"p.icon + '-sharp'\"></ion-icon>\n              <ion-label>{{ p.title }}</ion-label>\n            </ion-item>\n         \n          </ion-menu-toggle>\n     \n        </ion-list>\n\n      </ion-content>\n    </ion-menu>\n    <ion-router-outlet id=\"main-content\"></ion-router-outlet>\n  </ion-split-pane>\n</ion-app>\n");
